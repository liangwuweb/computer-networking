...
PARSER.add_argument(
    "-l", "--loss", type=float, default=0.0, help="The percentage of packets to drop."
)
PARSER.add_argument(
    "-d",
    "--delay",
...
PARSER.add_argument(
    "-f", "--file", required=True, help="The file to send over the wire."
)
PARSER.add_argument(
    "-r",
    "--receive",
...
PARSER.add_argument(
    "-v", "--verbose", action="store_true", help="Enable extra verbose mode."
)
...
if ARGS.summary:
    ...
    print("---")
    print(
        "File: {}\nLength: {}\nHash: {}".format(str(INPUT_PATH), INPUT_LEN, INPUT_HASH)
    )

    print("\nReceived")
    print("---")
    print("File: {}\nLength: {}\nHash: {}".format(str(RECV_PATH), RECV_LEN, RECV_HASH))
